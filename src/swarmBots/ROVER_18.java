...
public class ROVER_18 {
	...
	public ROVER_18(String serverAddress) {
		// constructor
		System.out.println("ROVER_18 rover object constructed");
		rovername = "ROVER_18";
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			//System.out.println("ROVER_18 equipment list results drive " + equipment.get(0));
			...
			if (blocked) {
				...
				if (goingEast) {
					...
					// (scanMap may be old data by now)
					System.out.println("ROVER_18 scanMapTiles[2][1].getHasRover() " + scanMapTiles[2][1].getHasRover());
					System.out.println("ROVER_18 scanMapTiles[2][1].getTerrain() " + scanMapTiles[2][1].getTerrain().toString());
